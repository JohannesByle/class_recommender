...
ReactDOM.render(
    <div>
        {FilterElement(CustomCheckBox("show_archived", "Show past terms"), -1, "m-0 mt-3 mb-2")}
        {FilterElement(CustomCheckBox("hide_conflicts", "Hide conflicting classes"), -2, "m-0 mb-2")}
        {filter_elements}
    </div>,
